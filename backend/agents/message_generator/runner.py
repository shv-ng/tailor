...
from .graph import MessageGeneratorState, compiled_graph
...
if __name__ == "__main__":
    ...
    print("⏳ Running Message Generator Agent...")
    analysis_result: MessageGeneratorState = run_message_generator(
        parsed_resume=parsed_resume_obj, parsed_jd=parsed_jd_obj
    )
    import pprint

    pprint.pprint(analysis_result.hr_email)
    pprint.pprint(analysis_result.referral_email)
